    ...
    namespace rtype {
        ...
        class Sprite {
            public:
                 ...
                 */
                Sprite(const std::string &filename = "", const std::size_t &x = 0, const std::size_t &y = 0, const size_t &scale = 1) : _filename(filename), _x(x), _y(y), _scale(scale) {};
                 ...
                 * 
                 * @return the x position as a const std::size_t&
                 */
                const std::size_t &getX() const {return _x;};
                 ...
                 */
                const std::size_t &getY() const {return _y;};
